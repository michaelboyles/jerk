...
import static io.github.michaelboyles.JavaExpression.booleanLiteral;
import static io.github.michaelboyles.JavaExpression.intLiteral;
import static io.github.michaelboyles.JavaExpression.longLiteral;
import static io.github.michaelboyles.JavaExpression.nullLiteral;
...
final class JavaCodeGenTest {
    ...
    @Test void generateJava() throws Exception {
        ...
        context.put("ListOfList", JavaClass.of(ArrayList.class)
            .withParam(JavaClass.of(io.github.michaelboyles.test.ArrayList.class))
        );
