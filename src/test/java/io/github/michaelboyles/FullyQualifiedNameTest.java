...
class FullyQualifiedNameTest {
    ...
    @Test void topLevelClass() {
        ...
        assertEquals("io.github.michaelboyles", fqn.packageName());
    ...
    @Test void innerClass() {
        ...
        assertEquals("io.github.michaelboyles", fqn.packageName());
        assertEquals("io.github.michaelboyles.FullyQualifiedNameTest$Foo", fqn.toString());
    ...
    @Test void innerClassOfInnerClass() {
        ...
        assertEquals("io.github.michaelboyles", fqn.packageName());
        assertEquals("io.github.michaelboyles.FullyQualifiedNameTest$Foo$Bar", fqn.toString());
