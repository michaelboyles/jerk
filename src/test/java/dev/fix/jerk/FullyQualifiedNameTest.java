...
class FullyQualifiedNameTest {
    ...
    @Test void topLevelClass() {
        ...
        assertEquals("dev.fix.jerk", fqn.packageName());
    ...
    @Test void innerClass() {
        ...
        assertEquals("dev.fix.jerk", fqn.packageName());
        assertEquals("dev.fix.jerk.FullyQualifiedNameTest$Foo", fqn.toString());
    ...
    @Test void innerClassOfInnerClass() {
        ...
        assertEquals("dev.fix.jerk", fqn.packageName());
        assertEquals("dev.fix.jerk.FullyQualifiedNameTest$Foo$Bar", fqn.toString());
